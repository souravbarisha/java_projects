package com.digital_atm.serviceimpl;
...
public class ATMServiceImpl implements ATMService {
	...
	public UserAccount createUser(UserAccountDTO userAccountDTO) {
		...
		String newPin = "congratulations your digital debit card has been created successfully, you card number is:"
	...
	public List<UserAccountDTO> getAllDetails() {
		...
		for (UserAccount account : accounts) {
			UserAccountDTO accountDTO = UserAccountDTO.builder().name(account.getName()).email(account.getEmail())
					.contact_number(account.getContact_number()).accountType(account.getAccountType())
					.CVV(account.getCVV()).expiryDate(account.getDate()).cardNumber(account.getCardNumber())
					.amount(account.getAmount()).pin(account.getPin()).build();
