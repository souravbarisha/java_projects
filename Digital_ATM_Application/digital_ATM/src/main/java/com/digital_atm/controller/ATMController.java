package com.digital_atm.controller;
...
import com.digital_atm.service.ATMService;
...
public class ATMController {
	...
	public ResponseEntity<UserAccount> updateUserData(@PathVariable int cardNumber,
			@RequestBody @Valid UserAccountDTO dto) {
	...
	public ResponseEntity<String> deleteUserById(@RequestParam("cardNumber") int cardNumber,
	...
	public ResponseEntity<String> deposite(@RequestParam("cardNumber") int cardNumber, @RequestParam("pin") int pin,
	...
	public ResponseEntity<String> withdraw(@RequestParam("cardNumber") int cardNumber, @RequestParam("pin") int pin,
			@RequestParam("amount") double amount) {
	...
	public ResponseEntity<String> changePinNumber(@PathVariable int cardNumber, @RequestParam("oldPin") int oldPin,
