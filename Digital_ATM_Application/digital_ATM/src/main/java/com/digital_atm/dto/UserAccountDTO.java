...
@AllArgsConstructor // using these annotations to use getter & setters, parametrized and
...
public class UserAccountDTO {
	...
	@Pattern(regexp = "^\\d{10}$", message = "Invalid phone Number!!!!") // to check wheter phone number is equal to 10
																			// digit
	...
	public UserAccountDTO(String name, String email, String contact_number, String accountType, Integer CVV,
			Double amount, Integer pin, Date expiryDate) {
		this.name = name;
		this.email = email;
